...
/// <summary>
/// This class is used to put the player character into a specific state, whenever enter a scene, whether different or not.
/// </summary>
public class CharacterEnterSceneState : MonoBehaviour
{
    [Serializable]
    ...
    void Awake ()
    {
        ...
        //playerdate = player.gameObject.GetComponent<PlayerData>();
    ...
    public void SetCharacterState ()
    {
        ...
        if(setCharacterVelocity)
            player.SetMoveVector (characterVelocity);

        if(setCharacterFacing)
            player.UpdateFacing(faceLeft);
