...
namespace Gamekit2D
{
    [CustomPropertyDrawer(typeof(CharacterEnterSceneState.ParameterSetter))]
    public class ParameterSetterDrawer : PropertyDrawer
    {
        ...
        CharacterEnterSceneState.ParameterSetter.ParameterType[] m_ParameterTypes;
        ...
        public override void OnGUI (Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            position.y += position.height;
            switch ((CharacterEnterSceneState.ParameterSetter.ParameterType)m_ParameterTypeProp.enumValueIndex)
            {
                case CharacterEnterSceneState.ParameterSetter.ParameterType.Bool:
                    EditorGUI.PropertyField (position, m_BoolValueProp);
                    break;
                case CharacterEnterSceneState.ParameterSetter.ParameterType.Float:
                    EditorGUI.PropertyField(position, m_FloatValueProp);
                    break;
                case CharacterEnterSceneState.ParameterSetter.ParameterType.Int:
        ...
        void ParameterSetterSetup (SerializedProperty property)
        {
            ...
            m_ParameterTypes = new CharacterEnterSceneState.ParameterSetter.ParameterType[parameters.Length];
            ...
            for (int i = 0; i < m_ParameterNames.Length; i++)
            {
                ...
                switch (parameters[i].type)
                {
                    case AnimatorControllerParameterType.Float:
                        m_ParameterTypes[i] = CharacterEnterSceneState.ParameterSetter.ParameterType.Float;
                        break;
                    case AnimatorControllerParameterType.Int:
                        m_ParameterTypes[i] = CharacterEnterSceneState.ParameterSetter.ParameterType.Int;
                        break;
                    case AnimatorControllerParameterType.Bool:
                        m_ParameterTypes[i] = CharacterEnterSceneState.ParameterSetter.ParameterType.Bool;
                        break;
                    case AnimatorControllerParameterType.Trigger:
                        m_ParameterTypes[i] = CharacterEnterSceneState.ParameterSetter.ParameterType.Trigger;
                        break;
                    default:
